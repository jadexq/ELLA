...
### Install ELLA <br>
Install ELLA follows the steps in [Install ELLA]({{ site.baseurl }}/ella_v1/install.html) if you haven't done so yet.
...
└── mini_demo.ipynb
```
The input data (`input/mini_demo_data.pkl`) mainly contains a dictionary of three dataframes corresponding to gene expression, cell segmentation, and nucleus segmentation (optional). The data contains 5 cells and 4 genes, and its details are explained in [ELLA's Inputs]({{ site.baseurl }}/ella_v1/inputs.html).
...
<div style="margin: 0 auto; text-align: center;"> 
  <img src="{{ site.baseurl }}/ella_v1/images/demo_lam_est.png" width="600" />
</div>	
...
```
<div style="margin: 0 auto; text-align: center;"> 
  <img src="{{ site.baseurl }}/ella_v1/images/demo_cells_genes.png" width="600" />
</div>	
