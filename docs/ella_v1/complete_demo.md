...
<img src="{{ site.baseurl }}/ella_v1/images/demo2_elbow.png" width="500" />
</div>
...
<div style="margin: 0 auto; text-align: center;"> 
<img src="{{ site.baseurl }}/ella_v1/images/demo2_est.png" width="500" />
</div>
We can overlay all genes in the same cluster in cells to have a more intuitive sense of the patterns.
<div style="margin: 0 auto; text-align: center;"> 
<img src="{{ site.baseurl }}/ella_v1/images/demo2_cells.png" width="600" />
</div>