...
<div style="margin: 0 auto; text-align: center;"> 
<img src="{{ site.baseurl }}/ella_v1/images/demo_ella_overview.png" width="600" />
</div>

*How to try it out?*\
ELLA is implemented in python with torch. Install ELLA library together with the dependencies follow the steps shown in [Install ELLA]({{ site.baseurl }}/ella_v1/install.html). After intalling ELLA, this [Minimum Demo]({{ site.baseurl }}/ella_v1/mini_demo.html) can be a good start. To take further steps, a complete demo, a showcase of input data, some advanced usages, and the scripts that we used for the real data anlayses in the ELLA manuscript are also shared via this website.
